  ...
  return (
    <Card className="border border-gold/20">
      <CardHeader className="flex flex-row items-center justify-between">
        <CardTitle className="text-lg font-semibold text-gold">Comissões</CardTitle>
      ...
      <CardContent className="space-y-6">
        <div className="grid grid-cols-3 gap-4">
          <div className="rounded-lg bg-background p-3 shadow-sm border border-gold/10">
        ...
        <div className="space-y-3">
          ...
          {commissionData.items.map(item => (
            <div key={item.id} className="flex items-center justify-between rounded-lg border border-gold/10 p-3">
              <div>
