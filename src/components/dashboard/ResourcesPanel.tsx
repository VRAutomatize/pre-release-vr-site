      ...
      <Tabs value={activeTab} onValueChange={handleTabChange} className="w-full">
        ...
        <TabsContent value="contracts" className="mt-0">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <ResourceCard icon={<FileText className="h-5 w-5 text-gold" />} title="Contrato Funcionário Digital Core" description="Modelo de contrato para o Funcionário Digital da Versão Core" onClick={() => handleResourceClick("Contrato Funcionário Digital Core")} />
            <ResourceCard icon={<FileText className="h-5 w-5 text-gold" />} title="Contrato Funcionário Digital Pro" description="Modelo de contrato para o Funcionário Digital da Versão Pro" onClick={() => handleResourceClick("Contrato Funcionário Digital Pro")} />
