...
const HeroSection = () => {
  ...
  return (
    <OptimizedBackground variant="hero">
      <div id="hero-section">
        <section className="min-h-[75vh] md:min-h-[80vh] flex items-start relative overflow-hidden pt-16 md:pt-20">
            ...
            <div className="flex flex-col items-center justify-center">
              ...
              <div className="w-full max-w-5xl text-center">
                ...
                <div className="animate-fade-up" style={{ animationDuration: "0.9s" }}>
                  <p className="text-base md:text-lg lg:text-xl xl:text-2xl text-foreground/80 mb-6 md:mb-8 lg:mb-10 leading-relaxed max-w-4xl mx-auto">
                    {isMobile 
                ...
                {/* Social Proof Stats - Cards mais largos e texto posicionado corretamente */}
                <div className="animate-fade-up mb-6 md:mb-8 lg:mb-10" style={{ animationDelay: "1.0s" }}>
                  <div className="grid grid-cols-3 gap-4 md:gap-6 lg:gap-8 mb-6 md:mb-8 lg:mb-10 max-w-2xl md:max-w-4xl lg:max-w-5xl mx-auto">
                    <div className="text-center bg-background/30 backdrop-blur-sm rounded-lg p-6 md:p-8 lg:p-10 border border-gold/10 hover:border-gold/30 transition-all duration-300 hover:scale-105">
                    ...
                    <div className="text-center bg-background/30 backdrop-blur-sm rounded-lg p-6 md:p-8 lg:p-10 border border-green-400/10 hover:border-green-400/30 transition-all duration-300 hover:scale-105">
                      <div className="flex flex-col items-center mb-3 md:mb-4">
                    ...
                    <div className="text-center bg-background/30 backdrop-blur-sm rounded-lg p-6 md:p-8 lg:p-10 border border-blue-400/10 hover:border-blue-400/30 transition-all duration-300 hover:scale-105">
                      <div className="flex flex-col items-center mb-3 md:mb-4">
