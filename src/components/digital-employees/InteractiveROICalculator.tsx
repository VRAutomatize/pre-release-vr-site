...
const InteractiveROICalculator = () => {
  ...
  const [calculatedSavings, setCalculatedSavings] = useState({ monthly: 0, yearly: 0, roi: 0 });

  useEffect(() => {
    // Calculation logic
    const monthlyCost = employees * (avgSalary + avgSalary * 0.8); // Salary + benefits
    const systemCost = 2500; // Base system cost
    const monthlySavings = monthlyCost * 0.7 - systemCost; // 70% reduction
  ...
  const handleCalculate = () => {
    // Trigger smooth scroll to results
      ...
      <section id="roi-calculator" className="py-16 md:py-24 bg-gradient-to-b from-card/20 to-transparent">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-4xl mx-auto">
            <Card className="p-8 md:p-12 bg-card/80 backdrop-blur-lg border-gold/20 rounded-2xl">
                ...
                <div>
                  ...
                  <div className="space-y-4">
                    <input
                      ...
                      className="w-full h-3 bg-card rounded-lg appearance-none cursor-pointer roi-slider"
                    />
                ...
                <div className="bg-card/40 rounded-xl p-6">
                  ...
                  <div className="space-y-3 text-foreground/80">
                    <div className="flex justify-between items-center">
                      <span>• Custo atual com {employees} funcionários/mês:</span>
                      <span className="font-semibold text-red-400">
                        R$ {(employees * (avgSalary + avgSalary * 0.8)).toLocaleString()}
                      </span>
                    </div>
                    <div className="flex justify-between items-center">
