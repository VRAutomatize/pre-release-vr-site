    ...
    <>
      ...
      <motion.nav
        ...
        className={`nav-premium transition-all duration-500 ${
          isScrolled ? 'premium-glass-dark' : 'bg-background/20'
        }`}
      >
        <div className="container-premium">
          <div className="flex items-center justify-between h-16">
            ...
            >
              <div className="w-8 h-8 premium-gold-gradient rounded-lg flex items-center justify-center">
                <span className="text-background font-bold text-sm">VR</span>
              </div>
            ...
            <motion.button
              ...
              className="premium-glass rounded-lg p-3 interactive-hover"
            >
                ...
                <div className="grid grid-cols-2 gap-3">
                  {navItems.map((item, index) => (
                    <motion.button
                      ...
                      onClick={item.action}
                      className={`premium-glass rounded-xl p-4 text-left interactive-hover ${
                        currentSection === item.id ? 'ring-2 ring-gold/50' : ''
                      }`}
                    >
