              ...
              <div className="flex flex-col md:flex-row gap-12 items-center">
                <div className="flex-1">
                  ...
                  <ul className="space-y-4 mb-8">
                    {[
                      "Cálculo estimado da sua economia anual com automação",
                      "Sugestão de processos para automatizar",
                ...
                <div className="flex-1 flex justify-center">
                  <img 
                    src="/lovable-uploads/0b4e9ef3-55f1-4f23-bd1a-eac74bd0bf8d.png" 
