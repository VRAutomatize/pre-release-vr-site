...
const DigitalEmployees = () => {
  ...
  return <div className="min-h-screen bg-background">
      ...
      <div className="container mx-auto px-4 pt-24 space-y-32">
        ...
        <PageHero title="Funcionários Digitais: Automatize sua Operação" subtitle="Reduza custos, escale seu negócio e elimine dores de contratação. Nossas soluções digitais substituem pessoas por sistemas que trabalham 24/7 — sem pausas, doenças ou oscilações." tag="Automação Inteligente">
          <div className="space-y-6">
            <p className="text-xl font-semibold text-gold mt-4 animate-fade-up" style={{
            animationDelay: "0.6s"
          }}>
          ...
          <div className="mt-8 md:mt-12 animate-fade-up" style={{
          animationDelay: "1s"
        }}>
            <HeroImage />
          </div>
